...
//
// Copied from github.com/transparency-dev/trillian-tessera/internal/witness/witness.go
// This will be deleted once a WitnessGateway is automatically initialized by Tessera.
package witness
...
func (wg *WitnessGateway) Witness(ctx context.Context, cp []byte) ([]byte, error) {
	...
	_, size, err := CheckpointUnsafe(cp)
	if err != nil {
